 ...
 * @fileoverview
 *
 * Apollo Client's DataProxy interfaces, extracted so we can avoid a circular
 * dependency, and adapted slightly for our convenience.
 *
...
export interface DataProxy {
   ...
   */
  readQuery<QueryType>(options: DataProxy.ReadQueryOptions): QueryType;
